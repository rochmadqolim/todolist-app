<div>
    <ul class="list-group mb-5" wire:sortable="updateTaskOrder">
        @foreach ($tasks as $item)
        <li class="list-group-item card mb-3 @if ($item->status === "1") bg-dark text-white completed @endif" wire:sortable.item="{{ $item->id }}" wire:key="task-{{ $item->id }}" wire:sortable.handle>
            <div class="card-body">
                <div class="row">
